...
import trimesh  # Replacing openmesh with trimesh
import re
import os
...
def open_file(file_name, opengl_obj, obj_path, obj_name, uv_label, material_label, drawcalls_label, vertices_label, triangles_label, edges_label):
    mesh = trimesh.load(file_name)  # Using trimesh to load the file
...
def show_message_box():
    title = "About CG - 3D Viewer"
    message = "3DViewer is a compact tool for \n" \
              "viewing 3D models in a user friendly way\n" \
              "Designed and Developed by Tanish and Neem.\n\n" \
              "Tech Stack: Python 3.9, Qt Designer,\n " \
              "PyQt5, OpenGL, trimesh and ModernGL.\n\n" \
              "Movement:\n" \
