...
class MainWindow(QtWidgets.QMainWindow):
    def __init__(self):
        # Load UI 
        QtWidgets.QMainWindow.__init__(self)
        uic.loadUi("%s/resource/3DView.ui" % os.path.dirname(__file__), self)
        ...
        self.wireframe_color.hide()
        self.background_color.hide()
        self.fov_slider.hide()
        self.fov_slider_value.hide()
        self.grid_slider.hide()
        self.grid_slider_value.hide()
        self.wireframe_slider.hide()
        self.wireframe_slider_value.hide()
        self.wireframe_radio.hide()
        self.solid_radio.hide()
        self.grid_cell.hide()
        self.grid_size.hide()
